...
export default function HomeHero({ onLoginClick }: HomeHeroProps) {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            {/* CTA Buttons - Only Login is functional */}
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg"
                onClick={() => onLoginClick()}
                className="bg-arab-gold hover:bg-arab-gold-dark text-arab-navy font-semibold group animate-pulse hover:animate-none hover:shadow-glow transition-all duration-300"
              >
                Login to Get Started
                <ArrowRight size={20} className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <span className="inline-flex items-center justify-center px-8 py-4 text-lg rounded-lg border-2 border-white text-white font-medium pointer-events-none opacity-75">
                View Demo
              </span>
            </div>
          </div>
