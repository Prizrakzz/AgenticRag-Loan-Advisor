          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="bg-gradient-to-br from-arab-navy to-arab-green p-8 lg:p-12 flex items-center justify-center relative overflow-hidden">
                ...
                {/* Feature Icon */}
                <div className="relative">
                  <div className="w-32 h-32 bg-white/20 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-sm">
                    {currentSlide === 0 && <FileCheck size={48} className="text-white" />}
                    {currentSlide === 1 && <BarChart3 size={48} className="text-white" />}
                    {currentSlide === 2 && <Shield size={48} className="text-white" />}
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <Button
                      variant="outline"
                      className="mt-4 border-white text-white hover:bg-white hover:text-arab-navy"
                    >
