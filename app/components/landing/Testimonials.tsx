...
export default function Testimonials() {
  ...
  const trustBadges = [
    { name: "Arab Bank", logo: "/api/placeholder/120/40" },
    { name: "Central Bank of Jordan", logo: "/api/placeholder/120/40" },
    { name: "ISO 27001", logo: "/api/placeholder/120/40" },
    { name: "PCI DSS", logo: "/api/placeholder/120/40" }
  ]
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 items-center">
            {trustBadges.map((badge, index) => (
              <div key={index} className="flex justify-center">
                <div className="bg-white/10 rounded-lg p-4 w-full text-center backdrop-blur-sm">
